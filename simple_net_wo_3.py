...
# Load data
features    = np.loadtxt('Data/mnist_wo_3_features.csv', delimiter=', ')
hard_labels = np.loadtxt('Data/mnist_wo_3_labels.csv', dtype='int', delimiter=', ')
soft_labels = np.loadtxt('Data/mnist_wo_3_logits.csv', delimiter=', ')
...
np.savetxt('Results/results_np_wo_3.csv', results_np, delimiter=', ')
np.savetxt('Results/results_np_w_repeat_wo_3.csv', results_np_w_repeat.reshape([Ts.shape[0], alphas.shape[0]*num_repeat]), delimiter=', ')
